    ...
    public void readstructure(String url, String user, String password) throws SQLException, ClassNotFoundException {
        ...
        if (null != tableList && tableList.size() > 0) {
            for (int i = 0; i < tableList.size(); i++) {
                ...
                String tableType = javaData.getTableType();
                CTable cTable = null;
                ...
                if (null != javaColumns && javaColumns.size() > 0) {
                    ...
                    String dbType = javaColumn.getDbType();
                    ...
                    String pkTableName = javaColumn.getPkTableName();
                    String pkColumnName = javaColumn.getPkColumnName();
                    Boolean isFk = javaColumn.getIsFk();
                    String fkTableName = javaColumn.getFkTableName();
                    String fkColumnName = javaColumn.getFkColumnName();
                    Boolean isUnique = javaColumn.getIsUnique();
                    Boolean isIndex = javaColumn.getIsIndex();
                    String indexType = javaColumn.getIndexType();
