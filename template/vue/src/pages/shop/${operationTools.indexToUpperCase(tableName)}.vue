...
<script>
    ...
    import {
        ...
        TableHeaderJson,
        searchWhereJson
    } from "@/jsonObj/${operationTools.indexToLowerCase(tableName)}";

    import '@/assets/admin/css/adminPage.css';
    import {
        API_findAll${operationTools.indexToUpperCase(tableName)},
        API_add${operationTools.indexToUpperCase(tableName)},
        API_update${operationTools.indexToUpperCase(tableName)},
        API_findId${operationTools.indexToUpperCase(tableName)},
        API_del${operationTools.indexToUpperCase(tableName)}
    } from "@/api/${operationTools.indexToLowerCase(tableName)}";
    import {
        CREATETREESTRUCTURE,
        TREE2ARRAY
